...
def _recover_gateway_restart_after_abort(
    ...
    *,
    ...
    # with the old service. If systemd-run is unavailable, or the launcher did
    # not identify a supported manager, fail closed rather than pretending the
    # in-cgroup child is independent.
